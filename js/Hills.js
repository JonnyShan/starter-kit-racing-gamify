...
const FAR_HILL_COUNT = 18;
const FAR_HILL_RING_RADIUS = 120;
const FAR_HILL_RING_VARIATION = 45;
const FAR_HILL_SIZE_MIN = 40;
const FAR_HILL_SIZE_MAX = 90;
const FAR_HILL_COLOR = 0x4f8a35;
const FAR_HILL_BASE_Y = -12;

const NEAR_HILL_COUNT = 44;
const NEAR_HILL_OFFSET = 16;
const NEAR_HILL_VARIATION = 12;
const NEAR_HILL_SIZE_MIN = 4;
const NEAR_HILL_SIZE_MAX = 12;
